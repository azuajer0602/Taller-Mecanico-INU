...
        {
          model: Repuesto,
          // CORRECCIÓN: Usar alias 'repuesto'
          as: 'repuesto', 
          attributes: ['nombre_repuesto', 'desc_repuesto']
        },
        {
          model: Proveedor,
          // CORRECCIÓN: Usar alias 'proveedor'
          as: 'proveedor',
...
      include: [
          // CORRECCIÓN: Usar alias en la respuesta
...
      include: [
          // CORRECCIÓN: Usar alias para obtener el resultado completo
        { model: Repuesto, as: 'repuesto' }, 
        { model: Proveedor, as: 'proveedor' }
      ]
    });
