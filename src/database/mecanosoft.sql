...
INSERT INTO `gasto` (`id_gasto`, `fecha_gasto`, `monto_gasto`, `descp_gasto`, `tipo_gasto`, `id_cate_gasto`, `metodo_pago`) VALUES
(1, '2025-11-03', 150.00, 'Compra de repuestos para motor', 'Repuestos y Materiales', NULL, 'Divisas');
-- --------------------------------------------------------
